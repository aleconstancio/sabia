...
<div class="flex flex-wrap gap-2 p-2 border-b border-border mb-2">
  <div class="flex items-center gap-1">
    <label class="text-xs text-muted-foreground" for="filter-date-from">De:</label>
  ...
  <div class="flex items-center gap-1">
    <label class="text-xs text-muted-foreground" for="filter-date-to">Até:</label>
    <input id="filter-date-to" type="date" bind:value={dateTo} class="text-xs rounded border border-border bg-input px-1 py-0.5 w-28" />
  </div>
  <div class="flex items-center gap-1">
    <label class="text-xs text-muted-foreground" for="filter-cloud-max">Nuvem máx:</label>
  ...
  <div class="flex items-center gap-1">
    <label class="text-xs text-muted-foreground" for="filter-sort-by">Ordenar:</label>
