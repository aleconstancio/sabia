...
> Complete endpoint reference for the SpaceEye backend. Interactive docs available at `/docs` when running.
...
**Response 200:** PDF file download (`spaceeye-esg-report.pdf`)
